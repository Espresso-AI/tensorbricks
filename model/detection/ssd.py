...
class SSD_Frame(nn.Module):
    ...
    def forward(self, input):
        ...
        return cls_out, reg_out, self.anchors
...
class SSD(SSD_Frame):
    ...
    __doc__ = r"""
        __version__ = 1.0
        __date__ = 2022.03.07
        __paper__ = https://arxiv.org/abs/1512.02325
        __checkpoints__ = https://github.com/lufficc/SSD
...
class SSD_ResNet(SSD_Frame):
    ...
    __doc__ = r"""
        __version__ = 1.0
        __date__ = 2022.03.07
        __paper__ = https://arxiv.org/abs/1701.06659
