...
class MobileNet_V2_Backbone(nn.Module):
    ...
    __doc__ = r"""
        __version__ = 1.0
        __date__ = 2022.03.07
        __paper__ = https://arxiv.org/abs/1801.04381
        __checkpoints__ = https://github.com/d-li14/mobilenetv2.pytorch
...
class MNASNet_Backbone(nn.Module):
    ...
    __doc__ = r"""
        __version__ = 1.0
        __date__ = 2022.03.07
        __paper__ = https://arxiv.org/abs/1807.11626
        __checkpoints__ = https://github.com/pytorch/vision/blob/main/torchvision/models/mnasnet.py
...
class MobileNet_V3_Large_Backbone(nn.Module):
    ...
    __doc__ = r"""
        ...
        __checkpoints__ = https://github.com/pytorch/vision/blob/main/torchvision/models/mobilenetv3.py
